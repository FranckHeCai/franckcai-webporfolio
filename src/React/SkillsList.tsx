...
const SkillsList = () => {
  ...
  const skills = {
    "Frontend": [
      ...
      "Applications connecting frontend and backend",
    ],
    "Backend": [
        ...
        {Object.entries(skills).map(([category, items]) => (
          <li key={category} className="w-full">
            <div
              ...
              className="md:w-[400px] w-full bg-neutral-800/70 rounded-2xl text-left hover:bg-opacity-80 transition-all border border-[var(--white-icon-tr)] cursor-pointer overflow-hidden"
            >
